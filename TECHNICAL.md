# Design Memory: technical reference

> Looking for the plain-English overview? Start with [README.md](README.md). This document is the full technical reference: architecture, every MCP tool, the rule table, install paths, and the quality gates.
